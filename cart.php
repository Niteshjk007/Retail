...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <li><a href="store_choose.php"><span class="glyphicon glyphicon-shopping-cart"></span>Stores</a></li>
                <li><a href="store.php?rid=<?php echo $_GET["rid"]; ?>"><span class="glyphicon glyphicon-shopping-cart"></span> Cart  (<?php
    ...
    <div class="site-section" style="background-image: url(images/back3.jpg); background-size: cover;" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center" data-aos="fade-up" data-aos-delay="400">
            ...
            ?>
                <div class="container">
                    <div class="jumbotron" style="margin-top: 4rem">
                        ...
                        <p style="color: rgb(77,77,77) !important">Looks Intresting...!!!</p>
                    </div>
                </div>
            ...
            ?>
                <tr style="background-color: #e9ecef">
                    ...
                    <td><a href="cart.php?action=delete&id=<?php echo $values["product_ID"]; ?>&rid=<?php echo $_GET["rid"]; ?>"><span class="text-danger">Remove</span></a></td>
                </tr>
            <?php 
        ...
        ?>
                <div class="container">
                    <div class="jumbotron" style="margin-top: 4rem">
                        <h1 style="color: rgb(77,77,77) !important">Your Shopping Cart</h1>
                        <p style="color: rgb(77,77,77) !important">Oops! Your cart is Empty. Go back and <a href="store.php?rid=<?php echo $_GET["rid"]; ?>">order now.</a></p>
