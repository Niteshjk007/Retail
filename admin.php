  ...
  <!-- <div class="site-wrap"> -->
          ...
          <div class="col-12 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                <li><a href="#section-add" class="nav-link" style="color: #212529 !important">Add Store</a></li>
    ...
    <div  class="site-section"  style="padding-top: 10rem">
        ...
        <table class="table table-striped table-hover container">
            ...
            <?php
                $query="select * from store order by store.S_ID";
                ...
                while($row=($result->fetch_assoc())){
                    ...
                    '
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#store'.$row['S_ID'].'">
                                    EXPAND
                                </button>
                                </td>
                            </tr>
    ...
    <?php
                ...
                while($row=($result->fetch_assoc())){
                    echo '
                        <div class="modal fade" id="store'.$row['S_ID'].'" tabindex="-1" role="dialog" aria-labelledby="storeLabel'.$row['S_ID'].'">
                                    <div class="modal-dialog mw-100 w-75" role="document"  >
                                        <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title text-primary" id="storeLabel'.$row['S_ID'].'">MANAGERS OF Stores: '.$row['name'].'</h3>
                            ...
                            ';
                    $query = "select * from manager where S_ID='".$row['S_ID']."'";
                    ...
                    '
                                        ...
                                        <div class="modal-footer">
                                            <a href="delete_store_action.php?id='.$row['S_ID'].'" type="button" class="btn btn-primary text-white">Delete Store</a>
                                            <a href="add_manager.php?id='.$row['S_ID'].'" type="button" class="btn btn-primary text-white">Add Manager</a>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-12 order-md-1" data-aos="fade-up">
                    ...
                    <h2 class="text-primary">ADD Store</h2>
                </div>
                <div id="customersignup">
                    <div class="row">
                        <div class="col-md-7">

                            <form action="add_store_action.php" method="POST" enctype="multipart/form-data" class="p-5 bg-white">
