  ...
  <!-- <div class="site-wrap"> -->
    ...
    <header class="site-navbar py-3 js-site-navbar site-navbar-target" role="banner" id="site-navbar">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                <li><a class="nav-link">Welcome, <?php echo $_SESSION["login_customer"]?></a></li>
                <li><a href="customer.php" class="nav-link">Previous Orders</a></li>
          ...
          <div class="d-inline-block d-xl-none ml-md-0 mr-auto py-3" style="position: relative; top: 3px;"><a href="#" class="site-store-toggle js-menu-toggle"><span class="icon-store h3"></span></a></div>
    ...
    <div class="jumbotron" style="color: #FFFFFF; margin-bottom: 0rem; background: #333333; border-radius:0rem">
        <div class="container text-center">
            <h1></h1>      
            <p>Choose the Store you want to purchase from</p>
        </div>
    </div>

    <div class="site-section" style="background-image: url(images/Back4.jpg); background-size:cover;" id="section-home">
        <div class="container" style="padding-top: 1rem">
            <div class="row align-items-center justify-content-center text-center" data-aos="fade-up" data-aos-delay="400">
            <?php
                $sql = "select * from store order by S_ID";
                            ...
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <p><img class=" img-fluid" src="images/Stores/Stores_<?php echo $row["S_ID"]; ?>.jpg" alt="card image"></p>
                            ...
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">All Stores Closed</h4>
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-5 mr-auto">
                ...
                <p>This is a Retail Store Management System, developed as a part of project of the Database Management System.</p>
              </div>
