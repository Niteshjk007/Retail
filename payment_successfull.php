...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
    ...
    <div class="site-section" id="section-home" style="background-image: url(images/back3.jpg); background-size: cover; margin-top: -2rem">
    ...
    <h2 class="text-center"> Thank you for choosing our Store ! Please Visit again .</h2>
    ...
    <div class="container" >
        ...
        <div class="box">
            ...
            <a href="store_choose.php"><button class="btn btn-success"><span class="glyphicon glyphicon-circle-arrow-left"></span> Another Order</button></a>
            </h1>
        </div>
    </div>
    </div>
