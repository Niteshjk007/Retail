    ...
    <div class="site-section" id="section-home" style="background-image: url(images/back3.jpg); background-size: cover; margin-top: -2rem">
        <div class="container">
            ...
            <h1 class="text-center" style="color: #e9ecef">Grand Total: &#8377;<?php echo "$g_total"; ?>/-</h1>
                ...
                <a href="cart.php?rid=<?php echo $_SESSION["cart"][0]["S_ID"]; ?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-circle-arrow-left"></span> Go back to cart</button></a>
