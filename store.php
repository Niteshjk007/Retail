  ...
  if($_GET["action"] == "add") {
    ...
    if(isset($_SESSION["cart"])) {
        ...
        if(!in_array($_GET["id"], $item_array_id)) {
            ...
            echo '<script>window.location="store.php?rid='.$_GET["rid"].'"</script>';
        } else {
...
if(!(isset($_GET["rid"]) || isset($_POST["S_ID"]))) {
    unset($_SESSION["cart"]);
  ...
  <!-- <div class="site-wrap"> -->
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <li><a href="store_choose.php"><span class="glyphicon glyphicon-shopping-cart"></span>Stores</a></li>
                <li><a href="cart.php?rid=<?php echo $S_ID;?>"><span class="glyphicon glyphicon-shopping-cart"></span> Cart  (<?php
                if(isset($_SESSION["cart"])){
                    $count = count($_SESSION["cart"]); 
                    echo "$count"; 
                } else
    ...
    <div class="jumbotron" style="color: #FFFFFF; margin-bottom: 0rem; background: #333333; border-radius:0rem">
        <div class="container text-center">
            ...
            <p>Choose thr products you wish to Purchase</p>
            <?php
                echo '<a href="cart.php?rid='.$S_ID.'" class="btn btn-primary btn-sm">Proceed to Checkout</a>'
            ?>
        </div>
    </div>
    
    <div class="site-section" style="background-image: url(images/Stores/store_1.jpg); background-size: cover" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center" data-aos="fade-up" data-aos-delay="400">
        <?php
                $sql = "select * from products where S_ID=".$S_ID." order by product_ID";
                $result = mysqli_query($conn, $sql);
                if ($result) {
                            ...
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <p><img class="img-fluid rounded mb-1 w-30" src="images/store_items/item_<?php echo $row["product_ID"]; ?>.jpg" alt="card image"></p>
                                        <form method="post" action="store.php?action=add&id=<?php echo $row["product_ID"]; ?>&rid=<?php echo $row["S_ID"]; ?>">
                            ...
                            <div class="frontside">
                                <div class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title">Oops! Nothing is available.</h4>
