<?php
    ...
    if(isset($_SESSION['login_customer'])){ //if customer logged in
      header('location: store_choose.php');
    }
...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2 site-logo">
            <h1 class="mb-0"><a href="index.php" class="text-white h3 mb-0">JK Stores</a></h1>
          </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/5215786.jpg);" data-aos="fade" data-stellar-background-ratio="0.5" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">Retail Store Management System</h1>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/5215786.jpg');" id="section-how-it-works">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="how-it-work-item">
              ...
              <div class="how-it-work-body">
                <h2>Choose a Store to Make an Order</h2>
                <p class="mb-5">Select the Store you want to Purchase from.</p>
                <p class="mb-5">Choose you favourite Item from the Store and place the order</p>
                <!-- <ul class="ul-check list-unstyled success">
                  <li class="text-white">Error minus sint nobis dolor</li>
                  <li class="text-white">Voluptatum porro expedita labore esse</li>
                  <li class="text-white">Voluptas unde sit pariatur earum</li>
    ...
    <div class="site-section border-bottom" id="section-our-team">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-7 col-lg-7 mb-1 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person">
              <img src="images/Shreyas.png" alt="Image" class="img-fluid rounded mb-1 w-30 " height="320px" width="335px">
              <h3>
                <div style="position:relative; left: 30px;">Shreyas NM</div></h3>
              <p class="position text-muted"><div style="position:relative; left: 30px;">USN: 1AY20IS105</div></p>
              <div style="position:relative; left: 30px;">
              <ul class="ul-social-circle">
                <li><a href="https://www.facebook.com/shreyas.gunda.395"><span class="icon-facebook"></span></a></li>
                <li><a href="#"><span class="icon-twitter"></span></a></li>
                <li><a href="https://in.linkedin.com/in/shreyas-nm-761088259?trk=people-guest_people_search-card"><span class="icon-linkedin"></span></a></li>
                <li><a href="https://www.instagram.com/shreyas__gunda/?hl=en"><span class="icon-instagram"></span></a></li>
              </ul>
              </div>
            </div>
          </div>
          <div class="col-md-5 col-lg-5 mb-1 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person">
              <img src="images/Nitesh2.jpeg" alt="Image" class="img-fluid rounded mb-1 w-30 " height="300px" width="300px">
              <h3>Nitesh JK</h3>
              <p class="position text-muted"><div style="position:relative; ">USN : 1AY20IS104</div></p>
              <ul class="ul-social-circle">
                <li><a href="https://www.facebook.com/nitesh.kalburgi"><span class="icon-facebook"></span></a></li>
                <li><a href="#"><span class="icon-twitter"></span></a></li>
                <li><a href="https://in.linkedin.com/in/nitesh-jk-9b1a66257?trk=people-guest_people_search-card"><span class="icon-linkedin"></span></a></li>
                <li><a href="https://www.instagram.com/nitesh_j_k/?hl=en"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-5 mr-auto">
                ...
                <p>This is an Retail Store Mangement System, developed as a part of project of the Database Management System.</p>
              </div>
